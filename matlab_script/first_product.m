time_file = fopen('time_records1_pro.txt','w');
...
save('product_order1.txt', 'first_order', '-ascii', '-tabs');
save('product_order2.txt', 'second_order', '-ascii', '-tabs');

S = {'camera1','camera2','camera3','camera4','camera5','camera6','camera7','camera8','camera9','camera10'};

order = importdata('product_order1.txt');
